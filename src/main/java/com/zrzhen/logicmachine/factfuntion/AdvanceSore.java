...
public class AdvanceSore {


    private static final Logger log = LoggerFactory.getLogger(AdvanceSore.class);
    ...
    public static void init() {
        try {
            execute = AdvanceSore.class.getMethod("execute", AtomicFact.class, String.class);
